...
extension ByteLevelBPETokenizer: Tokenizer {
        ...
        for segment in segments {
            ...
            case .special(let token):
                ...
                case .startOfTurn(let role):
                    ...
                    let roleLabel = chatMLRoleLabel(for: role)
    ...
    private func chatMLRoleLabel(for role: Role) -> String {
        switch role {
        case .assistant:
            return "assistant"
        case .user:
